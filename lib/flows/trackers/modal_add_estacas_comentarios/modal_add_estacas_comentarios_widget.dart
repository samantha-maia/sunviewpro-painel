...
import 'modal_add_estacas_comentarios_model.dart';
export 'modal_add_estacas_comentarios_model.dart';

class ModalAddEstacasComentariosWidget extends StatefulWidget {
  const ModalAddEstacasComentariosWidget({
    super.key,
    required this.id,
    required this.name,
    required this.qtdEstacas,
    this.newAdd,
    this.index,
  });
  ...
  final int? id;
  final String? name;
  final int? qtdEstacas;
  final String? newAdd;
  final int? index;

  @override
  State<ModalAddEstacasComentariosWidget> createState() =>
      _ModalAddEstacasComentariosWidgetState();
}

class _ModalAddEstacasComentariosWidgetState
    extends State<ModalAddEstacasComentariosWidget> {
  late ModalAddEstacasComentariosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalAddEstacasComentariosModel());
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'qqqxwryu' /* Deseja deixar um cometário ou ... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                    ...
                    ListView(
                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                if (FFAppConstants.um == widget!.id)
                                  wrapWithModel(
                                ...
                                if (FFAppConstants.dois == widget!.id)
                                  wrapWithModel(
                                ...
                                if (FFAppConstants.tres == widget!.id)
                                  wrapWithModel(
                                ...
                                if (FFAppConstants.quatro == widget!.id)
                                  wrapWithModel(
                                ...
                                if (FFAppConstants.cinco == widget!.id)
                                  wrapWithModel(
                                ...
                                if (FFAppConstants.seis == widget!.id)
                                  wrapWithModel(
                                    model: _model.standartArrayPierEdgeModel,
                                    updateCallback: () => safeSetState(() {}),
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'aga2iouw' /* Comentário sobre a estaca */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .labelSmall
                              .override(
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            maxLines: 6,
                            validator: _model.txtFieldTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
