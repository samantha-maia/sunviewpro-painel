...
import 'drop_manufactures_trackers_model.dart';
export 'drop_manufactures_trackers_model.dart';

class DropManufacturesTrackersWidget extends StatefulWidget {
  const DropManufacturesTrackersWidget({
    super.key,
    required this.equipamentsTypesId,
  });

  final int? equipamentsTypesId;

  @override
  State<DropManufacturesTrackersWidget> createState() =>
      _DropManufacturesTrackersWidgetState();
}

class _DropManufacturesTrackersWidgetState
    extends State<DropManufacturesTrackersWidget> {
  late DropManufacturesTrackersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DropManufacturesTrackersModel());
    ...
    return FutureBuilder<ApiCallResponse>(
      future: _model
        ...
        requestFn: () =>
          ...
          equipamentsTypeId: widget!.equipamentsTypesId,
        ),
      )
          .then((result) {
                          ...
                          itemBuilder: (context, listTypeManufacturersIndex) {
                            ...
                            return InkWell(
                              ...
                              child: InfoDropWidget(
                                key: Key(
                                    'Keyxfo_${listTypeManufacturersIndex}_of_${listTypeManufacturers.length}'),
