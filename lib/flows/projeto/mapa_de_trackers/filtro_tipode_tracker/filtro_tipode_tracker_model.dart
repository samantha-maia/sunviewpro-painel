...
import 'filtro_tipode_tracker_widget.dart' show FiltroTipodeTrackerWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class FiltroTipodeTrackerModel
    extends FlutterFlowModel<FiltroTipodeTrackerWidget> {
  ...
  final _filterTipoTrackerManager = FutureRequestManager<ApiCallResponse>();
  Future<ApiCallResponse> filterTipoTracker({
    String? uniqueQueryKey,
    bool? overrideCache,
    required Future<ApiCallResponse> Function() requestFn,
  }) =>
      _filterTipoTrackerManager.performRequest(
        uniqueQueryKey: uniqueQueryKey,
        overrideCache: overrideCache,
        requestFn: requestFn,
      );
  void clearFilterTipoTrackerCache() => _filterTipoTrackerManager.clear();
  void clearFilterTipoTrackerCacheKey(String? uniqueKey) =>
      _filterTipoTrackerManager.clearRequest(uniqueKey);
