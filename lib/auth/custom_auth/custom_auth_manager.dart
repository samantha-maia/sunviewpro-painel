...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    parqueSolarAuthUserSubject.add(
      ParqueSolarAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ParqueSolarAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ParqueSolarAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ParqueSolarAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    parqueSolarAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ParqueSolarAuthUser? currentUser;
